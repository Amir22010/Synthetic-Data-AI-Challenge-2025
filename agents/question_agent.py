...
class QuestioningAgent(object):
    ...
    def build_prompt(
        ...
        if wadvsys:
            sys_prompt = """CRITICAL: You MUST generate questions with LOGICALLY SOUND, VERIFIABLE answers and explanations.

            VERIFICATION REQUIREMENTS:
            1. CORRECT ANSWER must be DEFINITELY TRUE based on the question constraints
            2. EXPLANATION must LOGICALLY prove why the answer is correct
            3. ALL DISTRACTORS must be PLAUSIBLE but CLEARLY WRONG per the constraints
            4. Question must have ONE IRREFUTABLE SOLUTION through logical deduction
            ...
            sys_prompt = """You are a world-class logical reasoning expert with an IQ of 170, specializing in creating extremely challenging multiple-choice questions for elite competitive examinations. Your questions test the most sophisticated levels of analytical thinking and logical deduction."""
        tmpl = (
